...
//back to select level
  ...
  showcards = () =>{
   if(this.state.isSelect){
     ...
     <button  className='level-button'value={4} onClick={this.handleClick}>Easy</button>
     <button  className='level-button' value={8} onClick={this.handleClick}>Medium</button>
     <button  className='level-button' value={12} onClick={this.handleClick}>Hard</button>
   </div>)}
   else{
